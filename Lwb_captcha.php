 ...
 * $Id: Lwb_curl.php 17155 2017-02-06 06:29:05Z $
 例子：$ss=new Lwb_captcha(APP_ROOT.DIRECTORY_SEPARATOR."application".DIRECTORY_SEPARATOR."data".DIRECTORY_SEPARATOR."captcha".DIRECTORY_SEPARATOR);
        $ss->generate_image("ss");
 */
class Lwb_captcha
{
    /**
     ...
     * @var string  $folder
     */
    var $folder     = 'application/data/captcha';
